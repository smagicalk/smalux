...
use super::{config::SchedulerError, task::TaskRegistration};
...
impl Trigger {
    ...
    ///
    /// `every` 仍会在 Job 注册时按
    /// [`SchedulerConfig::minimum_interval`](crate::job::SchedulerConfig::minimum_interval) 校验。
...
pub struct RetryCondition {
    /// 是否重试 [`TaskError::Transient`](crate::job::TaskError::Transient)。
...
pub struct JobPatch {
    ...
    pub task: Option<TaskRegistration>,
